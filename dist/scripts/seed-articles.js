...
async function seedArticles() {
    try {
        ...
        const admin = await database_1.default.getRepository(User_1.User).findOne({
        ...
        const categoryRepo = database_1.default.getRepository(ArticleCategory_1.ArticleCategory);
        const categories = [
            {
                name: 'Community',
                slug: 'community',
        ...
        const articleRepo = database_1.default.getRepository(Article_1.Article);
        const articles = [
            {
